$(document).ready(function () {
   ...
   var teamData = [
    ...
    {name:'张刚',position:'执行董事',imgName:'teamerph10.png', des:[
        '张刚先生主要关注云与数字化等领域投资。张刚先生拥有丰富的企业管理咨询、软件与云服务产业工作经验。在加入公司之前，在埃森哲(咨询) 和甲骨文（软件）工作18年，服务于中国大中型企业和全球化运营企业的管理咨询、数字化转型、应用软件/SaaS、数据技术和云平台等。张刚先生曾长期全程参与某全球头部科技企业CRM战略、LTC线索到回款变革、Contract to Cash合同到现金，以及与产品研发IPD/供应链ISC/财经服务IFS等业务集成。',
        '张刚先生获得北京科技大学硕士和学士学位。',
    ],bp:true},
    ...
    {name:'任建军',position:'董事总经理',imgName:'teamerph05.png', des:[
        '任建军先生主要关注AI Infra等领域投后管理。在加入公司之前，曾参与创立创新创业加速器，并与腾讯合作深圳、广州等多个众创空间，为数十家创业企业提供战略、组织和市场运作方面的帮助。他曾在全球领先科技公司工作16年，拥有中国及北美丰富工作经验，负责过多项业务的MARKETING、产品管理部和硅谷创新中心等工作。任建军先生拥有丰富的云计算及通信网络行业的技术经验，也是战略设计、市场规划、产品策略等方面的管理专家，曾主持设计的某大型通讯系统在全球市场占有率第一。',
