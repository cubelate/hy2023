$(document).ready(function () {
   ...
   var teamData = [
    {name:'孙业林',position:'创始合伙人',imgName:'teamerph01.png',des:[
        '孙业林先生拥有丰富的IT产业从业和投资经验。曾长期担任全球头部科技公司高级副总裁，历任北京研究所所长、全球服务总裁、光网络产品线总裁、独联体片区总裁、运作与区域管理部总裁，积累了创新与产品组合管理、投资决策、服务管理、国际业务拓展及全球区域管理、领导力提升及变革管理等综合能力和丰富的行业资源。',
    ...
    {name:'汪崇儒',position:'执行董事',imgName:'teamerph07.png', des:[
        '汪崇儒先生主要关注人工智能、半导体和新能源等领域投资。在加入公司之前，曾参与创立由阿里巴巴战略投资的领先手机数码回收平台回收宝，并担任产品总监，负责公司整体的产品规划实施，更早之前曾就职于腾讯公司，任职产品经理。在过往的工作和创业经历中，汪崇儒先生积累了丰富的产品及系统设计经验，曾于腾讯就职期间完成近20项相关产品专利。',
    ...
    {name:'黄喜',position:'执行董事',imgName:'teamerph11.png', des:[
        '黄喜先生主要关注半导体、AI Infra等领域投资。在加入公司之前，曾在贝尔实验室（中国）等知名科技企业担任研究科学家、高级系统工程师，熟悉数据中心、光纤通信及相关行业标准。工作期间申请并获得了15篇中国专利和2篇美国专利。',
        '<b>黄喜先生参与投资的项目包括：</b>英诺赛科、集益威半导体、拓易科技、赛丽科技、超芯星半导体、格科微电子、行芯科技、珂玛材料、派恩杰半导体等。',
        '黄喜先生获得武汉光电国家实验室、华中科技大学光电子科学与工程学院博士学位、华中科技大学物理学院学士学位。',
    ],bp:true},
    {name:'张仲荣',position:'执行董事',imgName:'teamerph08.png', des:[
        '张仲荣先生主要关注人工智能、产业智能等领域投资。在加入公司之前，曾任友畅捷通（港股：01588）副总裁兼云业务运营中心总经理，更早之前就职新浪网、优视科技（UC浏览器）、三星中国等企业工作，并有过两段创业经历。张仲荣先生拥有超过14年互联网、移动互联网产品运营及创业经历，著有畅销书《互联网运营之道》、《运营本源》。',
        '<b>张仲荣先生参与投资的项目包括：</b>乐动机器人、科杰科技、票易通、云账户和凯茵化工等。',
        '张仲荣先生获得华中科技大学计算机科学与技术专业学士学位。',
    ],bp:true},
    {name:'撖涛',position:'投资董事',imgName:'teamerph12.png', des:[
        '撖涛先生主要关注半导体、智能终端等领域的投资。撖涛先生拥有十多年半导体传感器行业经验，在加入公司之前，曾服务于Sciosense、ams、Melexis等国际一线传感器芯片公司，也曾在多维科技参与创业，先后从事过研发、应用、产品管理、市场销售等多种重要职位，具有丰富的半导体产业经验。',
    ...
    {name:'张刚',position:'执行董事',imgName:'teamerph10.png', des:[
        '张刚先生主要关注人工智能和AI Infra和等领域投资。张刚先生拥有丰富的企业管理咨询、软件与云服务产业工作经验。在加入公司之前，在埃森哲(咨询) 和甲骨文（软件）工作18年，服务于中国大中型企业和全球化运营企业的管理咨询、数字化转型、应用软件/SaaS、数据技术和云平台等。张刚先生曾长期全程参与某全球头部科技企业CRM战略、LTC线索到回款变革、Contract to Cash合同到现金，以及与产品研发IPD/供应链ISC/财经服务IFS等业务集成。',
        '张刚先生获得北京科技大学硕士和学士学位。',
    ],bp:true},
    ...
    {name:'朱羚嘉 ',position:'投资副总裁',imgName:'teamerph14.png', des:[
        '朱羚嘉女士主要关注半导体和AI Infra等领域投资。加入公司之前，在ARM任汽车IP市场和生态经理，更早之前在恩智浦任汽车处理器事业部亚太区商务经理，拥有7年相关行业市场产品策略制定和运营相关经历。',
    ...
    {name:'童国栋',position:'企业成长合伙人、首席运营官',imgName:'teamerph03.png', des:[
        '童国栋先生负责管理咨询顾问服务。他致力于企业成长的组织能力打造、变革与模型方法的实践与研究。加入公司之前，在药明康德担任高级副总裁、COO/CHO、党委书记及八家公司的法人代表。作为核心人员，用五年多时间参与公司上市与市值摸高4500亿港币的组织能力打造与变革历程。另外，拥有在全球顶级科技公司研发、区域及总部职能运营、人力资源等领域近二十年的管理与实践经验。曾任该公司的企业大学校长助理、消费业务南太平洋地区及中国区总裁、消费业务EMT成员兼HRVP、集团人力资源部副总裁等。童国栋先生相信“有效的管理，能带来十倍数的增长”，重视管理、科学管理，是硬科技创业、发展到走向卓越的必由之路。',
        '童国栋先生获得武汉大学法学硕士学位。'
    ]},
    
    {name:'任建军',position:'董事总经理',imgName:'teamerph05.png', des:[
        '任建军先生主要负责AI Infra等领域投资研究和投后管理。在加入公司之前，曾参与创立创新创业加速器，并与腾讯合作深圳、广州等多个众创空间，为数十家创业企业提供战略、组织和市场运作方面的帮助。他曾在全球领先科技公司工作16年，拥有中国及北美丰富工作经验，负责过多项业务的MARKETING、产品管理部和硅谷创新中心等工作。任建军先生拥有丰富的云计算及通信网络行业的技术经验，也是战略设计、市场规划、产品策略等方面的管理专家，曾主持设计的某大型通讯系统在全球市场占有率第一。',
