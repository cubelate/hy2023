$(document).ready(function () {
   ...
   var teamData = [
    {name:'孙业林',position:'创始合伙人',imgName:'teamerph01.png',des:[
        ...
        '<b>孙业林先生投资的项目包括：</b>英诺赛科、伏达半导体、云豹智能、开元通信、旗芯微半导体、瓴芯电子、希微科技、格科微电子、行芯科技、汉朔科技、经纬恒润、云下科技、SmartX、开思汽配、票易通、中宏科创等。',
...
function getBounceframeInfo(index){
    ...
    if(obj.bp){
        var btnHtml = '<a class="btn_bp" href="http://www2.huacapital.com/form-bp.html" target="_blank">BP投送</a>'
