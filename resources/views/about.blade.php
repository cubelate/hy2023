            ...
            <div class="about_info_lt">
                ...
                <div class="des" >
                    <div class="des_contain">
                        ...
                        <p class="des_p">
                            我们重点关注半导体、AI infra、产业智能、智能终端等领域的投资机会，目前已经布局一批细分领域的领先企业，比如英诺赛科、伏达半导体、聚芯微电子、纵慧芯光、长晶科技、格科微电子（SH688728）、旗芯微半导体、为旌科技、超芯星半导体、集益威半导体、云豹智能、拓易科技、芯德半导体、行芯科技、珂玛材料（SZ301611）、胜达克半导体、经纬恒润（SH688326）、埃泰克汽车电子、汉朔科技（创业板已过会）、乐动机器人、SmartX、PPIO、科杰科技、云账户、开思汽配等。
                        </p>
                    </div>
                </div>
            </div>
